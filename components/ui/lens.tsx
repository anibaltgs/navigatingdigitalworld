...
// Export Rays and Beams if defined here
// Assuming Rays and Beams are defined in the same file

export const Rays: React.FC<{ className?: string }> = ({ className }) => {
  return (
    <svg
      width='380'
      height='397'
...
export const Beams: React.FC<{ className?: string }> = ({ className }) => {
  return (
    <svg
      width='380'
      height='315'
      ...
      xmlns='http://www.w3.org/2000/svg'
      className={cn(
        'pointer-events-none absolute left-1/2 top-0 w-full -translate-x-1/2',
        className
      )}
    >
      {/* SVG content */}
